...
public class Utils {
    ...
    public static String json = "{\n" +
            ...
            "   \"groups\":[\n" +
            "      {\n" +
            "         \"name\":\"Deportes opción 2\",\n" +
            "         \"image\":\"http:\\/\\/www.cuv3.com\\/wp-content\\/uploads\\/deportes.jpg\",\n" +
            "         \"stations\":[\n" +
            "            \n" +
            "            {\n" +
            "               \"name\":\"National Geographic\",\n" +
            "               \"image\":\"http:\\/\\/logok.org\\/wp-content\\/uploads\\/2014\\/06\\/National-Geographic-logo.png\",\n" +
            "               \"url\":\"http:\\/\\/vergol.com\\/live3\\/formula1.php\",\n" +
            "               \"isHost\":true\n" +
            "            }\n" +
            "         ]\n" +
            "      }\n" +
